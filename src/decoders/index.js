...
import * as entraId from './entraId.js';
...
export function cracker(token) {
    let tests = _.over(skypeToken.cracker, entraId.cracker, openid.cracker, jwt.cracker, regToken.cracker, syncState.cracker, base64.cracker);
